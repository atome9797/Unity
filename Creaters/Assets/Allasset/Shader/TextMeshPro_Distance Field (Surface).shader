...
SubProgram "d3d11 " {
Keywords { "DIRECTIONAL" "FOG_EXP" "GLOW_ON" "LIGHTPROBE_SH" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "DIRECTIONAL" "FOG_EXP" "GLOW_ON" "LIGHTPROBE_SH" "VERTEXLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "DIRECTIONAL" "FOG_EXP" "GLOW_ON" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP" "GLOW_ON" "POINT_COOKIE" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "DIRECTIONAL_COOKIE" "FOG_EXP" "GLOW_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP" "GLOW_ON" "POINT" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
