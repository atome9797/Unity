...
public class PlatformSpawner : MonoBehaviour {
    ...
    public float MinaxpawnCooltime = 2.25f; // 다음 배치까지의 시간 간격 최댓값
    ...
    void Start() {
        ...
        // MaxPlatformCount만큼의 크기를 가지는 배열 생성
    ...
    void Update() {
        ...
        if(_coolTime > _nextSpawnCooltime)
        {
            ...
            // 다음 쿨타임 설정 _nextSpawnCooltime 랜덤하게 설정
            _nextSpawnCooltime = Random.Range(MinSpawnCooltime, MinaxpawnCooltime);
